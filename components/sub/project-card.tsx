...
export const ProjectCard = ({
  ...
  return (
    <Link
      ...
      className="relative overflow-hidden rounded-2xl shadow-[0_0_30px_rgba(112,66,248,0.1)] hover:shadow-[0_0_40px_rgba(0,212,255,0.3)] transition-all duration-500 border border-[#7042f830] bg-[#0d0d1a]/50 backdrop-blur-xl group flex flex-col h-full w-full"
    >
